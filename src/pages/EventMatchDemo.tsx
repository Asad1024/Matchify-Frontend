          ...
          >
            <div className="text-center space-y-4 py-8">
              ...
              <p className="text-muted-foreground text-lg max-w-xl mx-auto">
                See how the countdown and match reveal work. Click below to start a 10-second countdown; when it finishes, sample matches will appear.
              </p>
            </div>
